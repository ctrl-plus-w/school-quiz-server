...
import { updateChoice, deleteChoice, getChoice, getChoices, postChoiceSpreader } from './choice.controller';
...
router.post('/', authorize([checkIsProfessor, checkQuizModifyPermission]), postChoiceSpreader);
